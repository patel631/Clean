...
This website helps to make ticket generate for stuff that you bought
	...
	<br> <a href="../jsp/ManageComplain.jsp">Manage Complain</a> <br>
...
<div class="main-content">
			...
			<div class="fivecol column last">
					<div class="widget">
					  <div class="widget-title"><h3 class="nomargin" style="text-align: left;">Register Complain</h3>
					  </div>
						<div class="widget-content">
						     <form action="<%= request.getContextPath()%>/ComplainAddController" method="POST" class="formatted-form">
						          <div class="message">
							  </div>
							        <div class="clear">
								   </div>
									...
									<div class="field-wrapper">
									  <label class="control-label" for="select02">Complain type:</label>
										...
										<div class="field-wrapper">
											...
											<option value="1">Complain Type</option>
										...
										<br/>
											<div class="field-wrapper">
							         <div class="field-wrapper"><input type="text" id="name" name="name" value="" placeholder="Subject" style="width:50%"/>
							         </div>
									</div>
							      ...
							      <br/>
							          <div class="field-wrapper">
							             <div class="field-wrapper"><textarea id="description" name="description" placeholder="Description" style="width:30%"" rows="5"></textarea></div>
								   </div>  
								   <br/>
