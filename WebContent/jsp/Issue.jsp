...
This website helps to make ticket generate for stuff that you bought
	...
	<br> <a href="../jsp/ManageIssue.jsp">Manage Issue</a> <br>
...
<div class="main-content">
			...
			<div class="fivecol column last">
					<div class="widget">
					  <div class="widget-title"><h3 class="nomargin" style="text-align: left;">Register Issue</h3>
					  </div>
						<div class="widget-content">
						     <form action="<%= request.getContextPath()%>/IssueController" method="POST" class="formatted-form">
						          <div class="message">
									...
									<div class="field-wrapper">
									  <label class="control-label" for="select02">Sub Category:</label>

										<div class="field-wrapper">
											<select id="select02" data-placeholder="Select your country" style="width:50%;" class="chzn-select-deselect" tabindex="7" name="subcatname">
									...
									<div class="field-wrapper">
									 ...
									 <div class="field-wrapper">
							         <div class="field-wrapper"><input type="text" id="name" name="name" value="" placeholder="Name" style="width:50%"/>
							         </div>
							      </div>
							      <br/>
							          <div class="field-wrapper">
								   ...
								   <br/>
									...
									<input type="hidden" name="issueflag" value="insert">
