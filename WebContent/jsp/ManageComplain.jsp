...
<div>
	...
	<br> <a href="../jsp/Complain.jsp">Go to Complain Page</a> <br>
<br/>
<br/>
</div>
<!--=====================
...
======================-->
 ...
 Connection connection = DbConnection.getConnection();
	String sql = "select * from clean_complaintype_mst";
	PreparedStatement preparedStatement = (PreparedStatement) connection.prepareStatement(sql);
 	ResultSet rs = preparedStatement.executeQuery();
 	%>
 	<table>
 	<th>ComplainType Id</th><th>ComplainType Name</th><th>ComplainType Description</th><th>Complain_Email</th>
 	<% 
 	while(rs.next())
 	{
 %>
 ...
 <tr>
				...
				<td><%=rs.getString("ComplainType_Id") %></td>				
				<td><%=rs.getString("ComplainType_Name") %></span></td>
				<td><%=rs.getString("ComplainType_Description") %></span></td>
				<td><%=rs.getString("Complain_Email")%> </td>
</tr>
